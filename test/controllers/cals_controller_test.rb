...
class CalsControllerTest < ActionController::TestCase
  ...
  test "should create cal" do
    assert_difference('Cal.count') do
      post :create, cal: { amount: @cal.amount, cals_on: @cal.cals_on, description: @cal.description }
    end
  ...
  test "should update cal" do
    patch :update, id: @cal, cal: { amount: @cal.amount, cals_on: @cal.cals_on, description: @cal.description }
    assert_redirected_to cal_path(assigns(:cal))
  end
